...
public class VolunteerController {
    ...
    public VolunteerProfileDTO getProfile(@PathVariable Long userId) {
        return volunteerService.getProfile(userId);
    }

    @PutMapping("/profile/{userId}")
    public VolunteerProfileDTO updateProfile(
            @PathVariable Long userId,
            @RequestBody VolunteerProfileDTO dto) {
        return volunteerService.updateProfile(userId, dto);
    }
    @GetMapping("/events")
